...
export const destinations = [
  {
    ...
    country: 'India',
    image: destKerala,
    description: 'Tranquil houseboat cruises in Alleppey backwaters, lush tea plantations of Munnar, Athirappilly waterfalls, and pristine tropical Kovalam beaches.',
    price: 'From ₹18,999',
    rating: 4.9,
    duration: '5-7 Days',
  },
  {
    ...
    country: 'UAE',
    image: destDubai,
    description: 'Experience futuristic luxury, desert safaris with dune bashing, Burj Khalifa 124th floor view, Marina dhow cruises, and World-class shopping malls.',
    price: 'From ₹34,999',
    rating: 4.9,
    duration: '4-6 Days',
  },
  {
    ...
    country: 'Himalayas',
    image: destBhutan,
    description: 'Land of the Thunder Dragon — discover Tiger’s Nest Monastery trek, Thimphu & Punakha dzongs, pristine Himalayan valleys, and rich heritage.',
    price: 'From ₹24,999',
    rating: 4.9,
    duration: '5-7 Days',
  },
  {
    ...
    description: 'The Land of Fire — explore the UNESCO Old City of Baku, futuristic Flame Towers, Gobustan mud volcanoes, and Caspian Sea boulevard.',
    price: 'From ₹32,999',
    rating: 4.8,
    duration: '4-6 Days',
  },
  {
    ...
    country: 'India',
    image: destGoa,
    description: 'Sun-kissed golden beaches, historic Portuguese churches, thrilling watersports, ocean cruises, and legendary beach shacks and nightlife.',
    price: 'From ₹12,999',
    rating: 4.8,
    duration: '3-5 Days',
  },
  {
    ...
    image: destMaldives,
    description: 'Crystal-clear turquoise lagoons, private luxury overwater villas, underwater dining experiences, and vibrant coral reef snorkeling.',
    price: 'From ₹45,999',
    rating: 4.9,
    duration: '5-8 Days',
  },
...
export const packages = [
  {
    id: 1,
    title: 'Kerala Backwaters & Munnar Paradise Special',
    tier: 'Trending',
    price: '₹18,999',
    ...
    image: destKerala,
    highlights: [
      'Overnight luxury Houseboat cruise with all traditional Kerala meals',
      'Munnar tea estate tour, Mattupetty dam & Elephant safari',
      'Alleppey backwater kayaking & Kathakali cultural show',
      'Private AC sedan for airport & railway station transfers',
      '4-Star resort stay with complimentary breakfast & dinner',
      'Spices plantation visit & Ayurvedic wellness massage coupon',
    ],
    popular: true,
  },
  {
    id: 2,
    title: 'Dubai Grand Luxury & Desert Safari Package',
    tier: 'Premium',
    price: '₹34,999',
    ...
    highlights: [
      ...
      'Dubai Marina luxury Dhow Dinner Cruise with Live Tanoura Show',
      'Abu Dhabi Full Day City Tour including Sheikh Zayed Grand Mosque',
      '4-Star central Dubai hotel stay with daily breakfast',
      'Express Dubai Visa processing & Airport transfer included',
    ],
    popular: true,
  },
  {
    id: 3,
    title: 'Bhutan Himalayan Kingdom Discovery Tour',
    tier: 'Exclusive',
    price: '₹24,999',
    duration: '6 Days / 5 Nights',
    destination: 'Bhutan',
    image: destBhutan,
    highlights: [
      'Guided trek to world-famous Paro Taktsang (Tiger’s Nest)',
      'Thimphu & Punakha Suspension Bridge sightseeing tour',
      'Traditional Bhutanese cultural dance performance & archery',
      'Full Sustainable Development Fee (SDF) & entry permits included',
      'Deluxe 3-Star hotel accommodation with all daily meals',
    ],
    popular: false,
  },
];
